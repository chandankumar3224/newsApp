...
async function fetchRandomData() {
  try {
    ...
    const api = `https://newsapi.org/v2/everything?q=india&pageSize=10&apiKey=${apiKey}`;
...
(async () => {
  try {
    document.querySelector(".nodata").style.display = "block";
    document.querySelector(".nodata").innerHTML = "RELAOD";
    console.log("changed");
    blogCart.classList.add("hide");
...
logo.addEventListener('click', () => {
  location.reload();
  console.log("bhai reload hogaya");
})
